    ...
    <Container>
      <Row className="mb-4">
        <Col md={3} className="mb-4 mb-md-0">
          <p>
            At Pathway Humanity, we team up with people, communities, and groups to help them reach their full potential,
            no matter where they're starting from. We're all about making change for the better.
          </p>
        </Col>
        ...
        <Col md={3} className="mb-4 mb-md-0">
          <h6 className="fw-bold mb-3" style={{ color: "#000" }}>Social</h6>
          <ul className="list-unstyled small">
            <li>
              <a
                href="https://instagram.com/pathwayhumanity/"
            ...
            <li>
              <a
                href="https://www.tiktok.com/@pathwayhumanity"
                className="footer-link"
                target="_blank"
                rel="noopener noreferrer"
              >
