      ...
      <Container>
        ...
        <Row className="mb-5">
          ...
          <Col md="8">
            <Card className="border-0 shadow-sm h-100">
              <CardBody>
                <h4 className="fw-bold">Kimberlie Flowers, MS LMFT</h4>
                <p>
        ...
        <Row>
          <Col md="4" className="mb-4 mb-md-0">
            <Card className="border-0 shadow-sm h-100">
              <CardImg top width="100%" src={dennisImg} alt="Dennis Belisle" />
            </Card>
          </Col>
          <Col md="8">
            <Card className="border-0 shadow-sm h-100">
              <CardBody>
                <h4 className="fw-bold">Dennis Belisle, USSF, NSCAA, FIFA, FBF, IOC</h4>
                <p>
