...
export default function RaceBlogPost() {
  return (
    <>
      <Head>
        <title>R.A.C.E. Formula for Mental Toughness | ABC Mental Toughness</title>
      </Head>
      <MainNavbar />
      <Container className="mt-5">
        <Row>
          <Col md={{ size: 10, offset: 1 }}>
            ...
            <p className="fs-5">
              I operate under this principle: <strong>Performance = Potential – Interference × Awareness.</strong> In other words, you perform at your best when there’s no interference — no mental or emotional blocks.
            </p>
            <p className="fs-5">
            ...
            <h2 className="mt-4" style={{ fontSize: '1.75rem' }}>R – Relentless</h2>
            <p className="fs-5">
            ...
            <h2 className="mt-4" style={{ fontSize: '1.75rem' }}>A – Awareness</h2>
            <p className="fs-5">
            ...
            <p className="fs-5">Most coaches or sports psychologists offer surface-level advice like:</p>
            <ul className="fs-5">
              <li>“Stop overthinking.”</li>
              <li>“Just believe in yourself.”</li>
            ...
            <h2 className="mt-4" style={{ fontSize: '1.75rem' }}>Lead with Your Mind</h2>
            <p className="fs-5">
            ...
            <p className="fs-5">
              In my view, the essence of mental toughness is this:
              <strong> The ability to replace negative thoughts with focused cues that enhance performance and build confidence. </strong>
            </p>
            <p className="fs-5">
            ...
            <h2 className="mt-4" style={{ fontSize: '1.75rem' }}>Effective Thought Replacement</h2>
            <p className="fs-5">
            ...
            <h2 className="mt-4" style={{ fontSize: '1.75rem' }}>C – Clear</h2>
            <p className="fs-5">
            ...
            <p className="fs-5">Examples I’ve helped young athletes break:</p>
            <ul className="fs-5">
              <li>I’m not good enough to win</li>
              <li>I don’t deserve success</li>
              <li>I’m too small</li>
              <li>I’m not fast enough</li>
              <li>Other people win, not me</li>
              <li>I can’t ___</li>
            </ul>
            <p className="fs-5">
            ...
            <h2 className="mt-4" style={{ fontSize: '1.75rem' }}>E – Emotional Mastery</h2>
            <p className="fs-5">
            ...
            <p className="fs-5">Your flow state is a mix of two things:</p>
            <ul className="fs-5">
              <li>What you're thinking</li>
            ...
            <p className="fs-5">
              In real-time: <strong>Beliefs → Thoughts → Emotions → Feelings → Performance</strong>
              <br />
              So if you want to control your performance, you must control your feelings.
            </p>

            <h2 className="mt-4" style={{ fontSize: '1.75rem' }}>Final Thoughts</h2>
            <p className="fs-5">
              If the negative mind is your challenge, the R.A.C.E. formula is your map. It works — especially when you work it.
            </p>
            <p className="fs-5">Ask yourself:</p>
            <ul className="fs-5">
              <li>When have you been relentless?</li>
              <li>When have you demonstrated deep awareness?</li>
              <li>When have you had total clarity?</li>
              <li>When have you mastered your emotions?</li>
            </ul>
            <p className="fs-5">
