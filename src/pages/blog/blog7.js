        ...
        <Row>
          <Col md={{ size: 10, offset: 1 }}>
            <h1 className="mb-4" style={{ fontSize: '2.5rem' }}>
              Tips for Tryouts: How to Stand Out and Make the Team
            </h1>
            <p className="fs-5">
            ...
            <h2 className="mt-4" style={{ fontSize: '1.75rem' }}>1 GET FIT</h2>
            <p className="fs-5">
            ...
            <h2 className="mt-4" style={{ fontSize: '1.75rem' }}>2 SHOW YOUR STRENGTHS</h2>
            <p className="fs-5">
            ...
            <h2 className="mt-4" style={{ fontSize: '1.75rem' }}>3 REMAIN POSITIVE</h2>
            <p className="fs-5">
            ...
            <h2 className="mt-4" style={{ fontSize: '1.75rem' }}>4 BE CONSISTENT</h2>
            <p className="fs-5">
            ...
            <h2 className="mt-4" style={{ fontSize: '1.75rem' }}>5 DON'T SPECIALIZE</h2>
            <p className="fs-5">
            ...
            <h2 className="mt-4" style={{ fontSize: '1.75rem' }}>6 PLAY SMART</h2>
            <p className="fs-5">
            ...
            <h2 className="mt-4" style={{ fontSize: '1.75rem' }}>7 PAY ATTENTION</h2>
            <p className="fs-5">
            ...
            <h2 className="mt-4" style={{ fontSize: '1.75rem' }}>8 RELAX</h2>
            <p className="fs-5">
